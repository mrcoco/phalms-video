$(document).ready(function(){
    ...
    var video_grid = $("#grid-video").bootgrid({
        ...
        multiSelect: true,
        templates: {
            header:"<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-6 actionBar\"><div class=\"{{css.search}}\"></div></div><div class=\"col-sm-6\"><div class=\"{{css.actions}}\"></div> <div class='btn btn-primary' id='create' class='command-add'> <span class=\"fa fa-plus-square-o\"></span> New Video</div></div></div></div>",
        },
        formatters: {
    ...
    function myForm(status,e) {
        ...
        if(status == 'edit') {
            ...
            $('#myvideo .modal-title').html('Edit video '+e.data("row-id"));
	 ...
	 $('#publish').val(data.publish);
            ...
            $('#myvideo .modal-title').html('Create New video ');
